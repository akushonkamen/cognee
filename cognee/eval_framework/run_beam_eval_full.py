...
eval_params = EvalConfig(
    ...
    dashboard=True,
    questions_path="beam_full_questions.json",
    answers_path="beam_full_answers.json",
    metrics_path="beam_full_metrics.json",
    aggregate_metrics_path="beam_full_aggregate_metrics.json",
    dashboard_path="beam_full_dashboard.html",
).to_dict()

# Full evaluation: no truncation (per the official script comment).
# Remove or increase this for full evaluation.
BEAM_MAX_BATCHES = None
